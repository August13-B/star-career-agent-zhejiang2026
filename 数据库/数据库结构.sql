...
CREATE TABLE `ai_conversation`  (
  ...
  `tbox_session_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '百宝箱平台会话ID',
  `tbox_conversation_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '百宝箱应用会话ID',
...
CREATE TABLE `ai_message`  (
  ...
  `tbox_message_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '百宝箱平台消息ID',
  `tbox_request_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '百宝箱请求ID（用于三方对账）',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `grow_plan`  (
  `id` bigint NOT NULL,
  `user_id` bigint NOT NULL,
  `match_id` bigint NULL DEFAULT NULL COMMENT '来自匹配结果（可空：报告可不经匹配直接生成）',
  ...
  `plan_type` tinyint NOT NULL DEFAULT 1 COMMENT '计划类型：1-1年，2-3年，3-5年',
  `start_date` date NULL DEFAULT NULL COMMENT '开始日期',
  `end_date` date NULL DEFAULT NULL COMMENT '结束日期',
...
CREATE TABLE `student_profile`  (
  ...
  `grade` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '年级（加密）',
  ...
  `target_city` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '目标城市（加密）',
  `expected_salary` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '期望薪资范围（加密）',
  `industry_preference` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '行业偏好（加密）',
  `work_type_preference` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '工作类型偏好（加密）',
  `max_learning_cycle` int NULL DEFAULT NULL COMMENT '可接受的最长学习周期（月）',
  `education` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '学历（加密）',
...
-- ----------------------------
-- Table structure for grow_task_record
-- ----------------------------
DROP TABLE IF EXISTS `grow_task_record`;
CREATE TABLE `grow_task_record`  (
